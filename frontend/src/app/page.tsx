  ...
  return (
    <>
      ...
      <main className="overflow-hidden">
        {/* Hero Section - Premium Saudi-themed */}
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
          {/* Animated background */}
          <div className="absolute inset-0 saudi-gradient-animated opacity-10"></div>
          ...
          <div className="absolute top-1/2 left-1/4 w-4 h-4 bg-green-500 rounded-full animate-pulse"></div>
          <div className="absolute top-1/3 right-1/4 w-3 h-3 bg-yellow-500 rounded-full animate-pulse" style={{ animationDelay: '0.5s' }}></div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-5xl mx-auto text-center">
              ...
              <div className="animate-fade-in-down">
                <div className="inline-flex items-center gap-3 mb-8 px-6 py-3 bg-white/90 backdrop-blur-sm rounded-full shadow-xl border border-green-100">
                  <span className="flex h-2 w-2 relative">
                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-green-400 opacity-75"></span>
                    <span className="relative inline-flex rounded-full h-2 w-2 bg-green-500"></span>
                  </span>
                  <span className="text-sm font-bold text-green-800">مكتبة المملكة الرقمية</span>
              ...
              <p className="animate-fade-in text-xl md:text-2xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed" style={{ animationDelay: '0.3s' }}>
                ...
                <span className="block mt-2 text-green-700 font-semibold">أكثر من ١٠,٠٠٠ عنوان متاح الآن</span>
              </p>
              
              {/* CTA Buttons */}
              <div className="animate-fade-in flex flex-wrap gap-4 justify-center" style={{ animationDelay: '0.5s' }}>
                <Link href="/books">
                  <Button size="lg" className="h-14 px-8 text-lg shadow-2xl hover:shadow-green-500/25 group">
                ...
                <Link href="/signup">
                  <Button variant="outline" size="lg" className="h-14 px-8 text-lg border-2 shadow-xl group">
                    <Sparkles className="mr-3 h-6 w-6 text-yellow-500 group-hover:rotate-12 transition-transform" />
                    إنشاء حساب مجاني
                  </Button>
                </Link>
              </div>
        ...
        <section className="py-24 lg:py-32 bg-gradient-to-b from-white to-green-50/50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <span className="inline-block px-4 py-2 bg-green-100 text-green-700 rounded-full text-sm font-bold mb-4">لماذا نحن مميزون</span>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: BookMarked, title: 'مجموعة واسعة', desc: 'آلاف الكتب في مختلف التصنيفات والمجالات', color: 'from-green-500 to-emerald-600', bgColor: 'from-green-100 to-green-50' },
                { icon: ShoppingCart, title: 'تسوق سهل', desc: 'تجربة شراء بسيطة وآمنة مع دفع موثوق', color: 'from-yellow-500 to-amber-600', bgColor: 'from-yellow-100 to-yellow-50' },
        ...
        <section className="py-24 lg:py-32 pattern-bg">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <span className="inline-block px-4 py-2 bg-yellow-100 text-yellow-700 rounded-full text-sm font-bold mb-4">التصنيفات</span>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
              {[
                ...
                { name: 'Religion', icon: BookOpen, label: 'الدين', color: 'from-green-600 to-emerald-500', lightColor: 'from-green-50 to-emerald-50' },
                { name: 'History', icon: Building, label: 'التاريخ', color: 'from-amber-600 to-orange-500', lightColor: 'from-amber-50 to-orange-50' },
                { name: 'Geography', icon: Globe, label: 'الجغرافيا', color: 'from-teal-500 to-green-500', lightColor: 'from-teal-50 to-green-50' }
              ].map((category, index) => (
                <Link 
                  key={category.name} 
        ...
        {/* Stats Section */}
        <section className="py-20 bg-gradient-to-r from-green-700 via-green-600 to-emerald-600 relative overflow-hidden">
          {/* Decorative elements */}
        ...
        <section className="py-24 lg:py-32 relative overflow-hidden">
          ...
          <div className="absolute bottom-1/4 right-1/4 w-48 h-48 bg-yellow-500/20 rounded-full blur-3xl animate-float" style={{ animationDelay: '1s' }}></div>
          
          <div className="container mx-auto px-4 text-center relative z-10">
            <div className="max-w-4xl mx-auto">
              <div className="mb-8">
                <Zap className="h-20 w-20 text-yellow-400 mx-auto animate-pulse-glow" />
              </div>
              <h2 className="text-4xl md:text-6xl font-black mb-6 text-white leading-tight">
                هل أنت مستعد
                <span className="block text-yellow-400">لبدء رحلة القراءة؟</span>
              </h2>
              <p className="text-xl text-white/90 mb-10 leading-relaxed max-w-2xl mx-auto">
                انضم إلى آلاف عشاق الكتب الذين وجدوا قراءاتهم المثالية معنا. سجل الآن واحصل على خصم ١٠٪ على طلبك الأول!
              </p>
              <Link href="/signup">
                <Button size="lg" className="h-16 px-12 text-xl bg-yellow-500 hover:bg-yellow-400 text-green-900 shadow-2xl hover:shadow-yellow-500/50 hover:scale-105 transition-all duration-300 font-bold">
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col lg:flex-row justify-between items-center gap-8">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <span className="text-2xl font-bold text-gradient-gold">مكتبة المملكة</span>
